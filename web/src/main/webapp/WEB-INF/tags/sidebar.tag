...
<div id="sidebarDiv">
	...
	<c:choose>
		<c:when test="${openAlerts}">
			<div id="alertsDivTop">
				...
				<img hspace="5" width="9" height="13" border="0" alt="+"
					src="../images/sidebar_collapse.gif"
					onclick="changeOpenDivButton(this)" />
			</div>
			<div id="alertsDiv" class="sideTopBar">
				<view:alertTag />
			</div>
		</c:when>
		<c:otherwise>
			<div id="alertsDivTop">
				<fmt:message key="alerts_messages" bundle="${resword}" />
				<img hspace="5" width="9" height="13" border="0" alt="+"
					src="../images/sidebar_expand.gif"
					onclick="changeOpenDivButton(this)" />
			</div>
			<div id="alertsDiv" style="display: none" class="sideTopBar">
				<view:alertTag />
			</div>
		</c:otherwise>
	</c:choose>
	...
	<c:choose>
		<c:when test="${openInstructions}">
			<div id="instructionsDivTop">
				<fmt:message key="instructions" bundle="${resword}" />
				<img hspace="5" width="9" height="13" border="0" alt="+"
					src="../images/sidebar_collapse.gif"
					onclick="changeOpenDivButton(this)" />
			</div>
			<div id="instructionsDiv" class="sideTopBar">
				<view:instructions />
			</div>
		</c:when>
		<c:otherwise>
			...
			<div id="instructionsDiv" style="display: none" class="sideTopBar">
				<view:instructions />
			</div>
		</c:otherwise>
	</c:choose>
	...
	<c:choose>
		<c:when test="${openInfo}">
			...
			<div id="infoDiv" class="sideTopBar">
				<view:sideinfo />
			</div>
		</c:when>
		<c:otherwise>
			...
			<div id="infoDiv" style="display: none" class="sideTopBar">
				<view:sideinfo />
			</div>
		</c:otherwise>
	</c:choose>
	...
	<c:if test="${showIcons}">
		...
		<div id="iconKeyDivTop">
			<fmt:message key="icon_key" bundle="${resword}" />
			<img hspace="5" width="9" height="13" border="0" alt="+"
				src="../images/sidebar_collapse.gif"
				onclick="changeOpenDivButton(this)" />
		</div>
		<div id="inconKeyDiv" class="sideTopBar">
			<view:sideicons />
		</div>
	</c:if>
</div>
