...
<c:set var="studySubjectject_subjectId"
	value="${param.studySubjectject_subjectId}" />
<c:set var="studySubjectjectId" value="${param.studySubjectjectId}" />
<c:set var="studySubjectjectStatusId"
	value="${param.studySubjectjectStatusId}" />
...
<c:if
	test="${studySubjectjectStatusId == 5 || studySubjectjectStatusId == 7}">
	<c:set var="crfStatus" value="invalid" />
</c:if>
<div
	id="Lock_<c:out value="${eblRowCount}"/>_<c:out value="${count}"/>_<c:out value="${subjectName}"/>"
	style="position: absolute; visibility: hidden; z-index: 3; width: 50px; height: 30px; top: 0px;">

	<c:choose>
		<c:when
			test="${crfStatus ==data_entry_completei18n ||crfStatus =='administrative editing'}">
			<!-- administrative editing -->
			<a
				href="javascript:leftnavExpand('Menu_on_<c:out value="${eblRowCount}"/>_<c:out value="${count}"/>_<c:out value="${subjectName}"/>'); javascript:leftnavExpand('Menu_off_<c:out value="${eblRowCount}"/>_<c:out value="${count}"/>_<c:out value="${subjectName}"/>');"
				onMouseOver="layersShowOrHide('visible','Event_<c:out value="${eblRowCount}"/>_<c:out value="${count}"/>_<c:out value="${subjectName}"/>');
		...
		javascript:setImage('CRFicon_<c:out value="${eblRowCount}"/>_<c:out value="${count}"/>_<c:out value="${subjectName}"/>','images/CRF_status_icon_Complete.gif');"><img
				src="images/spacer.gif" width="144" height="30" border="0"></a>
		...
		layersShowOrHide('hidden','Event_<c:out value="${eblRowCount}"/>_<c:out value="${count}"/>_<c:out value="${subjectName}"/>');
		layersShowOrHide('hidden','Lock_<c:out value="${eblRowCount}"/>_<c:out value="${count}"/>_<c:out value="${subjectName}"/>');
		javascript:setImage('CRFicon_<c:out value="${eblRowCount}"/>_<c:out value="${count}"/>_<c:out value="${subjectName}"/>','images/CRF_status_icon_InitialDEcomplete.gif');"><img
				src="images/spacer.gif" width="144" height="30" border="0"></a>
		...
		layersShowOrHide('hidden','Event_<c:out value="${eblRowCount}"/>_<c:out value="${count}"/>_<c:out value="${subjectName}"/>');
		layersShowOrHide('hidden','Lock_<c:out value="${eblRowCount}"/>_<c:out value="${count}"/>_<c:out value="${subjectName}"/>');
		javascript:setImage('CRFicon_<c:out value="${eblRowCount}"/>_<c:out value="${count}"/>_<c:out value="${subjectName}"/>','images/CRF_status_icon_DDE.gif');"><img
				src="images/spacer.gif" width="144" height="30" border="0"></a>
		...
		layersShowOrHide('hidden','Event_<c:out value="${eblRowCount}"/>_<c:out value="${count}"/>_<c:out value="${subjectName}"/>');
		layersShowOrHide('hidden','Lock_<c:out value="${eblRowCount}"/>_<c:out value="${count}"/>_<c:out value="${subjectName}"/>');
		javascript:setImage('CRFicon_<c:out value="${eblRowCount}"/>_<c:out value="${count}"/>_<c:out value="${subjectName}"/>','images/CRF_status_icon_Scheduled.gif');"><img
				src="images/spacer.gif" width="144" height="30" border="0"></a>
		...
		layersShowOrHide('hidden','Event_<c:out value="${eblRowCount}"/>_<c:out value="${count}"/>_<c:out value="${subjectName}"/>');
		layersShowOrHide('hidden','Lock_<c:out value="${eblRowCount}"/>_<c:out value="${count}"/>_<c:out value="${subjectName}"/>');
		javascript:setImage('CRFicon_<c:out value="${eblRowCount}"/>_<c:out value="${count}"/>_<c:out value="${subjectName}"/>','images/CRF_status_icon_Invalid.gif');"><img
				src="images/spacer.gif" width="144" height="30" border="0"></a>
		...
		layersShowOrHide('hidden','Event_<c:out value="${eblRowCount}"/>_<c:out value="${count}"/>_<c:out value="${subjectName}"/>');
		layersShowOrHide('hidden','Lock_<c:out value="${eblRowCount}"/>_<c:out value="${count}"/>_<c:out value="${subjectName}"/>');
		javascript:setImage('CRFicon_<c:out value="${eblRowCount}"/>_<c:out value="${count}"/>_<c:out value="${subjectName}"/>','images/CRF_status_icon_Started.gif');"><img
				src="images/spacer.gif" width="144" height="30" border="0"></a>
...
<div
	id="Event_<c:out value="${eblRowCount}"/>_<c:out value="${count}"/>_<c:out value="${subjectName}"/>"
	style="position: absolute; visibility: hidden; z-index: 3; width: 180px; top: 0px;">
											...
											<table border="0" cellpadding="0" cellspacing="0"
												...
												<tr valign="top">
													<td class="table_header_row_left"><fmt:message
															key="subject" bundle="${resword}" />: <c:out
															value="${subjectName}" /> <br> <fmt:message
															key="CRF" bundle="${resword}" />: <c:out
															value="${crfName}" /> <br> <c:choose>
															<c:when test="${crfStatus== 'invalid'}">
																<fmt:message key="status" bundle="${resword}" />: <fmt:message
																	key="removed" bundle="${resword}" />
															</c:when>
															<c:otherwise>
													...
													<c:choose>
														<c:when
															test="${crfStatus ==data_entry_completei18n ||
                         crfStatus =='administrative editing'}">
															<td class="table_header_row_left" align="right"><a
																href="javascript:leftnavExpand('Menu_on_<c:out value="${eblRowCount}"/>_<c:out value="${count}"/>_<c:out value="${subjectName}"/>'); javascript:leftnavExpand('Menu_off_1_6_1');"
																onClick="layersShowOrHide('hidden','Lock_all'); 
											layersShowOrHide('hidden','Event_<c:out value="${eblRowCount}"/>_<c:out value="${count}"/>_<c:out value="${subjectName}"/>');
											layersShowOrHide('hidden','Lock_<c:out value="${eblRowCount}"/>_<c:out value="${count}"/>_<c:out value="${subjectName}"/>');
											javascript:setImage('CRFicon_<c:out value="${eblRowCount}"/>_<c:out value="${count}"/>_<c:out value="${subjectName}"/>','images/CRF_status_icon_Complete.gif');">X</a></td>
														...
														<c:when
															test="${crfStatus ==initial_data_entry_completei18n}">
															<td class="table_header_row_left" align="right"><a
																href="javascript:leftnavExpand('Menu_on_<c:out value="${eblRowCount}"/>_<c:out value="${count}"/>_<c:out value="${subjectName}"/>'); javascript:leftnavExpand('Menu_off_1_6_1');"
																onClick="layersShowOrHide('hidden','Lock_all'); 
											layersShowOrHide('hidden','Event_<c:out value="${eblRowCount}"/>_<c:out value="${count}"/>_<c:out value="${subjectName}"/>');
											...
											javascript:setImage('CRFicon_<c:out value="${eblRowCount}"/>_<c:out value="${count}"/>_<c:out value="${subjectName}"/>','images/CRF_status_icon_Started.gif');">X</a></td>
												...
												<tr
													id="Menu_off_<c:out value="${eblRowCount}"/>_<c:out value="${count}"/>_<c:out value="${subjectName}"/>"
													style="display: all">
													<td class="table_cell_left" colspan="2"><c:choose>
															<c:when test="${crfStatus==no_startedi18n}">
																<c:choose>
																	<c:when test="${eventId>0}">
																		<i><fmt:message key="click_to_enter_data"
																				bundle="${restext}" /><br>
																		<fmt:message key="to_use_another_version_click"
																				bundle="${restext}" /></i>

																	</c:when>
																	<c:otherwise>
																		<i> <fmt:message
																				key="in_order_to_enter_data_create_event"
																				bundle="${restext}" /></i>
																	</c:otherwise>
																</c:choose>
															...
															<c:otherwise>
																<i><fmt:message key="click_for_more_options"
																		bundle="${restext}" /></i>
															</c:otherwise>
														</c:choose></td>
												</tr>
												<tr
													id="Menu_on_<c:out value="${eblRowCount}"/>_<c:out value="${count}"/>_<c:out value="${subjectName}"/>"
													style="display: none">
													<td colspan="2">
														<table border="0" cellpadding="0" cellspacing="0"
															width="100%">
																...
																<c:when
																	...
																	<tr valign="top">
																		<td class="table_cell_left"><a
																			href="ViewEventCRFContent?id=<c:out value="${subjectId}"/>&ecId=<c:out value="${eventCrfId}"/>&eventId=<c:out value="${eventId}"/>"><img
																				src="images/bt_View.gif" border="0" align="left"></a>&nbsp;&nbsp;
																			<a
																			href="ViewSectionDataEntry?eventDefinitionCRFId=<c:out value="${edcId}"/>&ecId=<c:out value="${eventCrfId}"/>&tabId=1"><fmt:message
																					key="view" bundle="${resword}" /></a></td>
																	</tr>
																	<tr valign="top">
																		<td class="table_cell_left"><a
																			href="javascript:openPrintCRFWindow('rest/clinicaldata/html/print/<c:out value="${study.oid}"/>/<c:out value="${studySubject.oid}"/>/<c:out value="${currRow.bean.studyEvent.studyEventDefinition.oid}"/>/<c:out value="${dec.eventCRF.crfVersion.oid}"/>')"
