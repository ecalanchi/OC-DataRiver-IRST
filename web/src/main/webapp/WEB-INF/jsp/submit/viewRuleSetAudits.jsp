...
<h1>
	...
	<fmt:message key="rule_audit_title" bundle="${resword}" />
	</span>
</h1>
										...
										<table border="0" cellpadding="0" cellspacing="0" width="100%">
											<tr valign="top">
												...
												<td class="table_header_row"><fmt:message
														key="rule_audit_updater" bundle="${resword}" /></td>
												<td class="table_header_row"><fmt:message
														key="rule_audit_update_date" bundle="${resword}" /></td>
											</tr>
											<c:forEach var="audit" items="${ruleSetAudits}">
												<tr valign="top">
													<td class="table_cell_left"><c:out
															value="${audit.status.name}" /></td>
													<td class="table_cell"><c:out
															value="${audit.updater.name}" /></td>
													<td class="table_cell <c:out value='${className}'/>"><fmt:formatDate
															value="${audit.currentUpdatedDate}"
									...
									<div class="tablebox_center">
										<table border="0" cellpadding="0" cellspacing="0" width="100%">
											...
											<c:forEach var="audit" items="${ruleSetRuleAudits}">
												<tr valign="top">
													<td class="table_cell_left"><c:out
															value="${audit.ruleSetRuleBean.ruleBean.name}" /></td>
													<td class="table_cell"><c:out
															value="${audit.status.name}" /></td>
													<td class="table_cell"><c:out
															value="${audit.updater.name}" /></td>
...
<p>
	<a href="ViewRuleSet?ruleSetId=${ruleSet.id}" />
	<fmt:message key="rule_go_back_to_Manage_rules" bundle="${resword}" />
	</a>
</p>
