...
<c:if test='${inputType == "text"}'>
	<input tabindex="<c:out value="${tabNum}"/>"
		style="background: white; color: #4D4D4D;"
		onChange="this.className='changedField'; javascript:setImage('DataStatus_top','images/icon_UnsavedData.gif'); javascript:setImage('DataStatus_bottom','images/icon_UnsavedData.gif');"
		type="text" name="input<c:out value="${itemId}" />"
		value="<c:out value="${inputTxtValue}"/>" />
	<c:if
...
<c:if test='${inputType == "textarea"}'>
	<textarea tabindex="<c:out value="${tabNum}"/>" disabled
		style="background: white; color: #4D4D4D;"
		onChange="this.className='changedField'; javascript:setImage('DataStatus_top','images/icon_UnsavedData.gif'); javascript:setImage('DataStatus_bottom','images/icon_UnsavedData.gif');"
...
<c:if test='${inputType == "checkbox"}'>
	<c:forEach var="option"
		...
		<c:choose>
			...
			<c:when test="${option.text eq inputTxtValue}">
				<c:set var="checked" value="checked" />
			</c:when>
			<c:otherwise>
...
<c:if test='${inputType == "single-select"}'>
	...
	<select tabindex="<c:out value="${tabNum}"/>"
		style="background: white; color: #4D4D4D;"
		onChange="this.className='changedField'; javascript:setImage('DataStatus_top','images/icon_UnsavedData.gif'); javascript:setImage('DataStatus_bottom','images/icon_UnsavedData.gif');"
...
<c:if test='${inputType == "multi-select"}'>
	<select multiple tabindex="<c:out value="${tabNum}"/>"
		style="background: white; color: #4D4D4D;"
...
<c:if test="${study.studyParameterConfig.discrepancyManagement=='true'}">
	...
	<td valign="top">
		...
		>--%>
		<img name="flag_input<c:out value="${itemId}" />"
