...
<c:if test='${inputType=="file"}'>
	<c:choose>
		<c:when test="${empty displayItem.data.value}">
			<input type="text" name="input<c:out value="${itemId}"/>"
				style="background: white; color: #4D4D4D;" value="">
		</c:when>
		<c:otherwise>
...
<c:if test='${inputType == "textarea"}'>
	<textarea name="input<c:out value="${itemId}" />" rows="5" cols="40"
		style="background: white; color: #4D4D4D;"><c:out
...
<c:if test='${inputType == "checkbox"}'>
	<c:forEach var="option"
		...
		<input type="checkbox" name="input<c:out value="${itemId}"/>"
...
<c:if test='${inputType == "radio"}'>
	<c:forEach var="option"
		...
		<input type="radio" name="input<c:out value="${itemId}"/>"
			value="<c:out value="${option.value}" />" <c:out value="${checked}"/> />
		<c:out value="${option.text}" />
		<c:if test="${! isHorizontal}">
			<br />
...
<c:if test='${inputType == "single-select"}'>
	...
	<select name="input<c:out value="${itemId}"/>" class="formfield"
		style="background: white; color: #4D4D4D;">
		<c:choose>
