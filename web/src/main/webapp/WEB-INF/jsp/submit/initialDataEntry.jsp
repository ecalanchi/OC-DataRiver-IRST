...
<form name="crfForm" method="POST" action="InitialDataEntry"
	...
	'CRF_infobox_closed').style.display='block'
	;document.getElementById('CRF_infobox_open').style.display='none'" >
	<input type="hidden" name="eventCRFId"
		...
		value="<c:out value="${checkInputsValue}"/>" /> <input type="hidden"
		name="tab" value="<c:out value="${tabId}"/>" />
	...
	<table border="0" cellpadding="0" cellspacing="0">
		<tr>
			...
			<td align="right" style="padding-left: 12px" id="TabsBackDis"><img
				src="images/arrow_back_dis.gif" border="0" /></td>
				...
				<div class="formfieldM_BG_noMargin">
					<select class="formfieldM" name="sectionName" size="1"
						...
						<c:forEach var="sec" items="${toc.sections}">
							<c:set var="tabUrl"
								value="InitialDataEntry?eventCRFId=${section.eventCRF.id}&sectionId=${sec.id}&tab=${tabCount}" />
