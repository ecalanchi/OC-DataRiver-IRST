...
<jsp:useBean scope='request' id='existingNameNotes'
	class='java.util.ArrayList' />
<jsp:useBean scope='request' id='existingIntrvDateNotes'
	class='java.util.ArrayList' />
...
<table border="0" cellpadding="0" cellspacing="0" onLoad="">
	...
	<c:choose>
		<c:when
			test="${study.studyParameterConfig.interviewerNameRequired == 'yes' || study.studyParameterConfig.interviewDateRequired == 'yes'}">
			<tr id="CRF_infobox_closed" style="display: none;">
				<td style="padding-top: 3px; padding-left: 6px; width: 250px;"
					nowrap><a
					href="javascript:leftnavExpand('CRF_infobox_closed'); leftnavExpand('CRF_infobox_open');">
						<img
						src="<c:out value="${contextPath}" />/images/sidebar_expand.gif"
						align="left" border="0" hspace="10"> <b><fmt:message
								key="CRF_info" bundle="${resword}" /></b>
				</a></td>
			</tr>
												...
												<div class="tab_R_h" style="padding-right: 40px;">
													<div class="tab_L_h"
														...
														<a
															href="javascript:leftnavExpand('CRF_infobox_closed'); leftnavExpand('CRF_infobox_open');">
															<img
															src="<c:out value="${contextPath}" />/images/sidebar_collapse.gif"
															align="left" border="0" hspace="10"> <b><fmt:message
																	key="CRF_info" bundle="${resword}" /></b>
														</a>
...
-->
																					<tr>
																						<!--event-->
																						<td class="table_cell_noborder"><b><fmt:message
																									key="event" bundle="${resword}" />:</b></td>
																						<td><c:out
																								value="${toc.studyEventDefinition.name}" />&nbsp;(<fmt:formatDate
																								value="${toc.studyEvent.dateStarted}"
																								pattern="${dteFormat}" />)</td>
																						<td class="table_cell_top"><span><b><fmt:message
																										key="gender" bundle="${resword}" />:</b></span></td>
																						<td class="table_cell_noborder"
																							style="padding-left: 3px"><c:choose>
																					...
																					<tr>
																						<!-- Occurence id-->
																						<td class="table_cell_noborder"><c:if
																								test="${toc.studyEventDefinition.repeating}">

																								<b><fmt:message key="occurrence_number"
																										bundle="${resword}" />:</b>
																							</c:if></td>
																						...
																						<!-- Age at Enrollment-->
																						<td class="table_cell_top"><b><fmt:message
																									key="age_at_enrollment" bundle="${resword}" />:</b><br>

																						</td>
																						<td class="table_cell_noborder"><c:out
																								value="${age}" /><br></td>
																					...
																					<tr>
																						<!--study-->
																						<td class="table_cell_noborder"><b><fmt:message
																									key="study" bundle="${resword}" />:</b><br></td>
																						...
																						<td class="table_cell_top"><c:if
																								...
																								<c:choose>
																									<c:when
																										...
																										<b><fmt:message key="date_of_birth"
																												bundle="${resword}" />:</b>
																										<br />
																									</c:when>
																									<c:otherwise>
																										<b><fmt:message key="year_of_birth"
																												bundle="${resword}" />:</b>
																										<br />
																									</c:otherwise>
																								</c:choose>
         ...
         the date of birth, we will have to use the Date.getYear() deprecated method.--%>
																								...
																								<c:choose>
																									<c:when
																										test="${study.studyParameterConfig.collectDob == '2' && subject.dateOfBirth.year != null}">${subject.dateOfBirth.year + 1900}</c:when>
																									<c:otherwise>
																					...
																					<tr>
																						...
																						<td class="table_cell_noborder"><b><fmt:message
																									key="site" bundle="${resword}" />:</b><br></td>
																						...
																						<c:choose>
																							<c:when
																								test="${study.studyParameterConfig.personIdShownOnCRF == 'true'}">
																								<td class="table_cell_top"><b><fmt:message
																											key="person_ID" bundle="${resword}" />:</b><br />
																								</td>
																								<td class="table_cell_noborder"><c:out
																										value="${subject.uniqueIdentifier}" /><br />
																								</td>
...
form element in red <c:out value="FORMMESSAGES: ${formMessages} "/><br/>--%>
																					...
																					<tr>
																						<td class="table_cell_left" nowrap><c:if
																								test="${study.studyParameterConfig.interviewerNameRequired != 'not_used'}">
																								<c:choose>
																									<c:when test="${isInError_Int}">
																										<fmt:message key="interviewer_name"
																											bundle="${resword}" />: <span
																											class="aka_exclaim_error">! </span> &nbsp;
																									...
																									<c:otherwise>
																										<fmt:message key="interviewer_name"
																											bundle="${resword}" />:
            <c:if
																											test="${study.studyParameterConfig.interviewerNameRequired=='yes'}">
                *
            </c:if>
            &nbsp;
        </c:otherwise>
																						...
																						<td class="table_cell_left"><c:if
																								...
																								<table border="0" cellpadding="0"
																									...
																									<tr>
																										...
																										<td valign="top">
																											<!--  formfieldM_BG--> <c:choose>
																												<c:when
																													test="${study.studyParameterConfig.interviewerNameEditable=='true'}">
																													<c:choose>
																														<c:when test="${isInError_Int}">
																															<div class="aka_input_error">
																																<label for="interviewer"></label><input
																																	id="interviewer" type="text"
																																	name="interviewer" size="15"
																												...
																												<c:otherwise>
																													<div class=" formfieldM_BG">
																														<input type="text" disabled size="15"
																															value="<c:out value="${interviewer}" />"
																															class="formfieldM"> <input
																															type="hidden" name="interviewer"
																															value="<c:out value="${interviewer}" />">
																												</c:otherwise>
																											</c:choose>
																											</div> <%--BWP>>new error message design:  <jsp:include page="../showMessage.jsp">
                          <jsp:param name="key" value="interviewer" />
                        </jsp:include>--%>
																										</td>
																										<td valign="top" nowrap><c:set
																												var="isNewDN"
																												value="${hasNameNote eq 'yes' ? 0 : 1}" /> <c:if
																												...
																												<c:choose>
																													<c:when test="${hasNameNote eq 'yes'}">
																														<a href="#" id="nameNote1"
																															onmouseout="UnTip();"
																															onmouseover="callTip(genToolTipFromArray('interviewNotes'));"
																															onClick="openDNoteWindow('ViewDiscrepancyNote?writeToDB=1&subjectId=${studySubject.id}&itemId=${itemId}&id=${InterviewerNameNote.eventCRFId}&name=${InterviewerNameNote.entityType}&field=interviewer&column=${InterviewerNameNote.column}&enterData=${enterData}&monitor=${monitor}&blank=${blank}','spanAlert-interviewDate'); return false;">
																															<img id="flag_interviewer"
																															name="flag_interviewer"
																													...
																													<c:otherwise>
																														<a id="nameNote1" href="#"
																															onmouseout="UnTip();"
																															onmouseover="callTip(genToolTipFromArray('interviewNotes'));"
																															onClick="openDSNoteWindow('CreateDiscrepancyNote?subjectId=${studySubject.id}&viewData=y&id=<c:out value="${toc.eventCRF.id}"/>&name=eventCrf&field=interviewer&column=interviewer_name&writeToDB=1&new=${isNewDN}','spanAlert-interviewer'); return false;">
																															<img id="flag_interviewer"
																															name="flag_interviewer"
																									...
																									<tr>
																										<td valign="top"><span
																											ID="spanAlert-interviewer" class="alert"></span>
																										</td>
																									</tr>
																								</table>
																							</c:if></td>

																						<td class="table_cell" nowrap><c:if
																								test="${study.studyParameterConfig.interviewDateRequired != 'not_used'}">
																								<c:choose>
																									<c:when test="${isInError_Dat}">
																										<fmt:message key="interview_date"
																											bundle="${resword}" />: <span
																											class="aka_exclaim_error">! </span>&nbsp;<br />
																									...
																									<c:otherwise>
																										<fmt:message key="interview_date"
																											bundle="${resword}" />:
            <c:if
																											test="${study.studyParameterConfig.interviewDateRequired=='yes'}">
                *
            </c:if>&nbsp;<br />
																										<%--(<fmt:message key="date_format" bundle="${resformat}"/>)--%>
																									</c:otherwise>
																										...
																										<td valign="top"><c:choose>
																												<c:when
																													...
																													<c:choose>
																														<c:when test="${isInError_Dat}">
																															<div class="aka_input_error">
																																<label for="interviewDate"></label> <input
																																	id="interviewDate" type="text"
																																	name="interviewDate" size="15"
																																	value="<c:out value="${interviewDate}" />"
																																	class="aka_input_error">
																														</c:when>
																														<c:otherwise>
																															<div class="formfieldM_BG">
																																<input id="interviewDate" type="text"
																																	name="interviewDate" size="15"
																																	value="<c:out value="${interviewDate}" />"
																																	class="formfieldM">
																														</c:otherwise>
																												...
																												<c:otherwise>
																													<div class="formfieldM_BG">
																														<input id="interviewDate" type="text"
																															...
																															value="<c:out value="${interviewDate}" />"
																															class="formfieldM"> <input
																															type="hidden" name="interviewDate"
																															value="<c:out value="${interviewDate}" />">
																												</c:otherwise>
																											</c:choose>
                          ...
                          <jsp:param name="key" value="interviewDate" />
																										...
																										<td valign="top" nowrap><a href="#">
																												...
																												border="0" id="interviewDateTrigger" />
                    ...
                    and switched it back for 2898--%>
																												...
																												<c:choose>
																													<c:when
																														test="${IntrvDateNoteResStatus == 0}">
																														<c:set var="imageFileName"
																															value="icon_noNote" />
																													</c:when>
																													<c:when
																														test="${IntrvDateNoteResStatus == 1}">
																														<c:set var="imageFileName"
																															value="icon_Note" />
																													</c:when>
																													<c:when
																														test="${IntrvDateNoteResStatus == 2}">
																														<c:set var="imageFileName"
																															value="icon_flagYellow" />
																													</c:when>
																													<c:when
																														test="${IntrvDateNoteResStatus == 3}">
																														<c:set var="imageFileName"
																															value="icon_flagGreen" />
																													</c:when>
																													<c:when
																														test="${IntrvDateNoteResStatus == 4}">
																														<c:set var="imageFileName"
																															value="icon_flagBlack" />
																													</c:when>
																													<c:when
																														test="${IntrvDateNoteResStatus == 5}">
																														<c:set var="imageFileName"
																															value="icon_flagWhite" />
																													</c:when>
																													<c:otherwise>
																												...
																												<c:choose>
																													...
																													<c:otherwise>
																														<a href="#"
																															onmouseover="callTip(genToolTipFromArray('dateNotes') );"
																															onmouseout="UnTip();"
																															onClick="openDNoteWindow('CreateDiscrepancyNote?subjectId=${studySubject.id}&id=<c:out value="${toc.eventCRF.id}"/>&name=eventCrf&field=interviewDate&column=date_interviewed&writeToDB=1&new=${isNewDNDate}','spanAlert-interviewDate'); return false;">
																															<img id="flag_interviewDate"
																															name="flag_interviewDate"
																															src="<c:out value="${contextPath}" />/images/icon_noNote.gif"
																															border="0"
																									...
																									<tr>
																										<td valign="top"><span
																											ID="spanAlert-interviewDate" class="alert"></span>
																										</td>
																									</tr>
																								</table>
																							</c:if></td>
																					...
																					<tr>
																						...
																						<td colspan="5" valign="top"
																							class="table_cell_left"><b>Discrepancy
																								Notes on this CRF:</b></td>
																						...
																						<table border="0" cellspacing="1" cellpadding="0"
																							...
																							<tr>
																								<td valign="top" align="center"
																									...
																									width="20%"><fmt:message key="open"
																										bundle="${resword}" /></td>
																								<td valign="top" align="center"
																									class="table_cell_left"
																									style="border-right: 1px solid #E6E6E6; color: #D4A718;"
																									width="20%"><fmt:message key="updated"
																										bundle="${resword}" /></td>
																								<td valign="top" align="center"
																									class="table_cell_left"
																									style="border-right: 1px solid #E6E6E6; color: #7CB98F;"
																									width="20%"><fmt:message key="resolved"
																										bundle="${resword}" /></td>
																								<td valign="top" align="center"
																									class="table_cell_left"
																									style="border-right: 1px solid #E6E6E6; color: black;"
																									width="20%"><fmt:message key="closed"
																										bundle="${resword}" /></td>
																								<td valign="top" align="center"
																									class="table_cell_left"
																									style="border-right: 1px solid #E6E6E6; color: black"
																									width="20%"><fmt:message
																										key="not_applicable" bundle="${resword}" /></td>
																							</tr>
																							<tr>
																								<td valign="top" align="center"
																									class="table_cell_left"
																									style="border-right: 1px solid #E6E6E6; color: #CC0000;"
																									width="20%"><c:out value="${openNum}" /></td>
																								<td valign="top" align="center"
																									class="table_cell_left"
																									style="border-right: 1px solid #E6E6E6; color: #D4A718;"
																									width="20%"><c:out value="${updatedNum}" /></td>
																								<td valign="top" align="center"
																									class="table_cell_left"
																									style="border-right: 1px solid #E6E6E6; color: #7CB98F;"
																									width="20%"><c:out value="${resolvedNum}" /></td>
																								<td valign="top" align="center"
																									class="table_cell_left"
																									style="border-right: 1px solid #E6E6E6; color: black;"
																									width="20%"><c:out value="${closedNum}" /></td>
																								<td valign="top" align="center"
																									class="table_cell_left"
																									style="border-right: 1px solid #E6E6E6; color: black"
																									width="20%"><c:out value="${notAppNum}" /></td>
																							</tr>
																						</table>
																					</tr>
