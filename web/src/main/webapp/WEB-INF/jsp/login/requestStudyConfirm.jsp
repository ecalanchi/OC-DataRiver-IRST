...
<jsp:useBean scope="session" id="newRole"
	class="org.akaza.openclinica.bean.login.StudyUserRoleBean" />
<h1>
	<span class="title_manage"><fmt:message
			key="confirm_your_study_acces_request" bundle="${resword}" /></span>
</h1>
...
<form action="RequestStudy?action=submit" method="post">
										...
										<div class="textbox_center">
											<table border="0" cellpadding="0">
												...
												<tr valign="top">
													...
													<td class="table_cell"><c:out
															value="${newRole.studyName}" /></td>
												</tr>
												<tr>
													<td class="table_header_column"><fmt:message
															key="role_of_access_requested" bundle="${resword}" />:</td>
													<td class="table_cell"><c:out
															value="${newRole.role.description}" /></td>
												</tr>
	...
	<input type="submit" name="Submit"
		value="<fmt:message key="submit_request" bundle="${resword}"/>"
