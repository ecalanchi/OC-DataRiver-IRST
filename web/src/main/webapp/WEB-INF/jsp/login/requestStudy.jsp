...
<P>
	<fmt:message key="fill_out_form_to_request_study" bundle="${restext}" />
<p>
<form action="RequestStudy" method="post">
											...
											<table border="0" cellpadding="0">
												...
												<tr>
													<td class="formlabel"><fmt:message
															key="study_requested" bundle="${resword}" />:</td>
													<td><div class="formfieldXL_BG">
															...
															<select name="studyId" class="formfieldXL">
																...
																name="key" value="studyId" /></jsp:include></td>
												</tr>

												<tr>
													<td class="formlabel"><fmt:message
															key="role_of_access_requested" bundle="${resword}" />:</td>
													<td><c:set var="role1" value="${newRole.role}" />
														<div class="formfieldXL_BG">
															<select name="studyRoleId" class="formfieldXL">
																...
																name="key" value="studyRoleId" /></jsp:include></td>
												</tr>
	...
	<input type="submit" name="Submit"
		value="<fmt:message key="confirm_study_access" bundle="${resword}"/>"
