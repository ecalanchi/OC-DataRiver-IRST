...
<jsp:useBean scope="request" id="currRow"
	class="org.akaza.openclinica.web.bean.DatasetRow" />
					...
					<tr>
						<c:choose>
							<c:when test='${currRow.bean.status.name == "removed"}'>
								...
								<td><a
									href="RestoreDataset?dsId=<c:out value="${currRow.bean.id}"/>"
							...
							<c:otherwise>
								<td><a
									href="ViewDatasets?action=details&datasetId=<c:out value="${currRow.bean.id}"/>"
									...
									onMouseUp="javascript:setImage('bt_View1','images/bt_View.gif');"><img
										...
										align="left" hspace="6"></a></td>
								<td><a
									href="EditDataset?dsId=<c:out value="${currRow.bean.id}"/>"
								...
								<td><a
									href="RemoveDataset?dsId=<c:out value="${currRow.bean.id}"/>"
								...
								<td><a
									href="ExportDataset?datasetId=<c:out value="${currRow.bean.id}"/>"
									...
									onMouseUp="javascript:setImage('bt_Export1','images/bt_Export.gif');"><img
										name="bt_Export1" src="images/bt_Export.gif" border="0"
										alt="<fmt:message key="export_dataset" bundle="${resword}"/>"
										title="<fmt:message key="export_dataset" bundle="${resword}"/>"
										align="left" hspace="6"></a></td>
							</c:otherwise>
						</c:choose>
					</tr>
							...
							<c:otherwise>
								<td><a
									...
									onMouseUp="javascript:setImage('bt_View1','images/bt_View.gif');"><img
										...
										align="left" hspace="6"></a></td>
								<td><c:if
										test="${currRow.bean.owner.name == userBean.name}">
