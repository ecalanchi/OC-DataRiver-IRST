...
<jsp:useBean scope="request" id="currRow"
	class="org.akaza.openclinica.web.bean.ArchivedDatasetFileRow" />
<tr>
	...
	<td class="table_cell"><a target="_new"
		...
		href="ExportDataset?action=delete&datasetId=<c:out value="${currRow.bean.datasetId}"/>&adfId=<c:out value="${currRow.bean.id}"/>">
			<img name="bt_Delete1" src="images/bt_Delete.gif" border="0"
			alt="<fmt:message key="delete" bundle="${resword}"/>"
			title="<fmt:message key="delete" bundle="${resword}"/>" align="left"
			hspace="6"
