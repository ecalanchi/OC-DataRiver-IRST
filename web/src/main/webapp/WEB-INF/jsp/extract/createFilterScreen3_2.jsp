...
<form action="CreateFiltersTwo" name="cf2">
	...
	<br /> <input type="submit"
		value="<fmt:message key="select_data_elements_and_continue" bundle="${restext}"/>"
		class="button_xlong" />
</form>
