									...
									<div class="box_BL">
										<div class="box_BR">
											...
											<div class="textbox_center" align="center">
												...
												<span class="title_extract"> <c:choose>
														<c:when test='${param.selectStudyEvents=="1"}'>
															<b><fmt:message
																	key="select_items_or_event_subject_attributes"
																	bundle="${resword}" /></b>
														</c:when>
														<c:otherwise>
															<fmt:message
											...
											<div class="textbox_center" align="center">
												...
												<span class="title_extract"> <c:choose>
														<c:when test='${param.longitudinalScope=="1"}'>
															<b><fmt:message key="define_temporal_scope"
																	bundle="${resword}" /></b>
														</c:when>
														<c:otherwise>
															<fmt:message key="define_temporal_scope"
																bundle="${resword}" />
														</c:otherwise>
													</c:choose> <br>
												<br>
											...
											<div class="textbox_center" align="center">
												...
												<span class="title_extract"> <c:choose>
														<c:when test='${param.specifyMetadata=="1"}'>
															<b><fmt:message key="specify_dataset_properties"
																	bundle="${resword}" /></b>
														</c:when>
														<c:otherwise>
															<fmt:message key="specify_dataset_properties"
																bundle="${resword}" />
														</c:otherwise>
													</c:choose> <br>
												<br>
											...
											<div class="textbox_center" align="center">
												...
												<span class="title_extract"> <c:choose>
														<c:when test='${param.saveAndExport=="1"}'>
															<b><fmt:message key="save_and_export"
																	bundle="${resword}" /></b>
														</c:when>
														<c:otherwise>
