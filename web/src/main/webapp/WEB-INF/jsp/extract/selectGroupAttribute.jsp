...
<h1>
	<span class="title_manage"><fmt:message key="create_dataset"
			bundle="${resword}" />: <fmt:message key="select_group_attributes"
			bundle="${resword}" /></span>
</h1>
...
<fmt:message key="instructions_extract_select_CRF_and_group"
	bundle="${resword}" />

<form action="CreateDataset" method="post" name="cl">
	<input type="hidden" name="action" value="beginsubmit" /> <input
		type="hidden" name="crfId" value="0"> <input type="hidden"
		name="groupAttr" value="1">
	...
	<p>
		...
		<fmt:message key="select_all_groups" bundle="${resword}" />
	</p>
										...
										<div class="textbox_center" align="center">
											<table border="0" cellpadding="0" cellspacing="0"
												...
												<tr>
													...
													<td class="table_header_column_top"><fmt:message
															key="subject_groups" bundle="${resword}" /></td>
													<td class="table_header_column_top"><fmt:message
												...
												<c:forEach var='sgclass' items='${allSelectedGroups}'>
													...
													<tr>
														...
														<td class="table_cell"><c:forEach var='group'
																items='${sgclass.studyGroups}' varStatus='status'>
																<c:choose>
