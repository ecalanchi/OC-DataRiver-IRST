...
<h1>
	<span class="title_manage"><c:out value="${study.name}" />: <fmt:message
			key="extract_datasets" bundle="${resworkflow}" /> <a
...
<OL>
	<LI><a href="ViewDatasets"><fmt:message key="view_datasets"
				bundle="${resworkflow}" /></a>
	<LI><a href="CreateDataset"><fmt:message key="create_dataset"
				bundle="${resword}" /></a> <!--<LI><a href="CreateFiltersOne">View Filters</a>-->
