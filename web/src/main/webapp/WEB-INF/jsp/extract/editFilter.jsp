...
<h1>
	<span class="title_manage"><fmt:message key="edit_filter"
			bundle="${restext}" />: <c:out value="${filter.name}" /></span>
</h1>
...
<form action="EditFilter">
	<input type="hidden" name="action" value="validate" /> <input
		type="hidden" name="filterId" value="<c:out value='${filter.id}'/>" />
	<table>
		<tr>
			<td><jsp:include page="../showMessage.jsp"><jsp:param
						name="key" value="fName" />
				</jsp:include></td>
	...
	<br /> <input type="submit"
		value="<fmt:message key="edit_this_filter" bundle="${resword}"/>"
		class="button_xlong" />
