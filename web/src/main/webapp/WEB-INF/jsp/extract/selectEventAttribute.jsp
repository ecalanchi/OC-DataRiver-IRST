...
<jsp:useBean scope="request" id="subjectAgeAtEvent"
	class="java.lang.String" />

<h1>
	<span class="title_manage"><fmt:message key="create_dataset"
			bundle="${resword}" />: <fmt:message key="select_event_attributes"
			bundle="${resword}" /></span>
</h1>
...
<p>
	...
	<fmt:message key="left_side_info_panel" bundle="${restext}" />
