...
<jsp:useBean scope="request" id="currRow"
	class="org.akaza.openclinica.web.bean.FilterRow" />
		...
		<table border="0" cellpadding="0" cellspacing="0">
			<tr>
				<c:choose>
					...
					<c:otherwise>
						<td><a
							href="ApplyFilter?action=details&filterId=<c:out value="${currRow.bean.id}"/>"
						...
						<td><a
							href="ApplyFilter?action=validate&submit=Apply Filter&filterId=<c:out value="${currRow.bean.id}"/>"
							...
							onMouseUp="javascript:setImage('bt_Export1','images/bt_Export.gif');"><img
								...
								alt="<fmt:message key="apply_filter" bundle="${resword}"/>"
								title="<fmt:message key="apply_filter" bundle="${resword}"/>"
								align="left" hspace="6"></a></td>
