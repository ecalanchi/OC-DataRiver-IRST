...
<jsp:useBean scope="request" id="crfVersionBean"
	class="org.akaza.openclinica.bean.submit.CRFVersionBean" />
<jsp:useBean scope="request" id="crfBean"
...
<body>
	<div class="headerDiv">
		...
		<h1>
			<span class="title_manage"> <c:out value="${crfBean.name}" />
				<c:out value="${crfVersionBean.name}" /></span>
