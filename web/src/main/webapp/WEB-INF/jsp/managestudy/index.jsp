...
<!-- then instructions-->
<div id="sidebar_Instructions_open" class="sidebar_tab"
	style="display: all">
	...
	<div class="sidebar_tab_content">
		...
		<fmt:message key="director_coordinator_privileges_manage"
			bundle="${restext}" />
		<br>
		<br>
...
<div id="sidebar_Instructions_closed" class="sidebar_tab"
	style="display: none">
													...
													<table border="0" cellpadding="0" cellspacing="0"
														...
														<tr valign="top">
															<td class="table_cell" align="right" colspan="3"><c:if
																...
																</c:if> <c:if test="${study.status.available}">
                             | <a href="AddNewSubject"><fmt:message
																			key="add_new" bundle="${resword}" /></a>
																</c:if></td>
														</tr>
													</table>
															...
															<tr valign="top">
																<td class="table_cell" align="right" colspan="3"><c:if
																		...
																		<a href="ListSite"><fmt:message key="show_all"
																				bundle="${resword}" /></a>
																	</c:if> <c:if test="${!study.status.locked}">
                         | <a href="CreateSubStudy"><fmt:message
																				key="add_new" bundle="${resword}" /></a></td>
														</c:if>
														</tr>
														</c:if>
				...
				<div class="box_T">
					<div class="box_L">
						<div class="box_R">
                            ...
                            | <a href="DefineStudyEvent"><fmt:message
																				key="add_new" bundle="${resword}" /></a>
																	</c:if></td>
															</tr>
														</c:if>
