...
<h1>
	<span class="title_manage"><fmt:message key="set_user_role"
			bundle="${resword}" /></span>
</h1>
...
<form action="SetStudyUserRole" method="post">
	...
	<input type="hidden" name="studyId"
		value="<c:out value="${uRole.studyId}"/>">
									...
									<div class="box_BR">
										...
										<div class="tablebox_center">
											<table border="0" cellpadding="0" cellspacing="0"
												...
												<tr>
													<td class="formlabel"><fmt:message key="study_name"
															bundle="${resword}" />:</td>
													<td><c:out value="${uRole.studyName}" /></td>
												</tr>
												<tr>
													<td class="formlabel"><fmt:message
															key="study_user_role" bundle="${resword}" />:</td>
																				...
																				<div class="box_BR">
																					...
																					<div class="textbox_center" align="center">
																						...
																						<span class="title_manage"> <b><fmt:message
																									key="set_user_role" bundle="${resword}" /></b>
