...
<jsp:useBean scope="session" id="studyEvent"
	class="org.akaza.openclinica.bean.managestudy.StudyEventBean" />

<body>
	<h1>
		<span class="title_manage"> <c:out value="${section.crf.name}" />
			<c:out value="${section.crfVersion.name}" /></span>
		...
		<table border="0" cellpadding="0" cellspacing="0" width="650"
			...
			<tr>
				...
				<td class="table_cell_noborder" style="color: #789EC5"><c:out
						...
						value="${EventCRFBean.dateInterviewed}" pattern="${dteFormat}" />)</td>
				<td class="table_cell_top" style="color: #789EC5"><b><fmt:message
	...
	<c:choose>
		...
		<c:otherwise>
			<jsp:include
				page="../managestudy/showSectionWithoutCommentsPrint.jsp" />
		</c:otherwise>
	</c:choose>
