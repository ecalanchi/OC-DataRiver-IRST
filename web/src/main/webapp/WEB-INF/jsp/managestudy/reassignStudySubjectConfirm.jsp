...
<jsp:useBean scope="request" id="newStudy"
		...
		<td>
			<h1>
				<span class="title_manage"> <fmt:message
						key="confirm_reassign_study_subject" bundle="${restext}" />
				</span>
			</h1>
			...
			<form action="ReassignStudySubject" method="post">
				...
				<input type="hidden" name="studyId"
					value="<c:out value="${newStudy.id}"/>">
				<p>
					<fmt:message key="you_choose_to_reassign_subject2"
						bundle="${restext}" />
					<b><c:out value="${subject.uniqueIdentifier}" /></b>
					<fmt:message key="to_study" bundle="${restext}" />
					<b><c:out value="${newStudy.name}" /></b>.
				</p>
																				...
																				<div class="box_BL">
																					<div class="box_BR">
																						...
																						<div class="textbox_center" align="center">
																							...
																							<span class="title_manage"> <fmt:message
																									key="manage_study" bundle="${resworkflow}" />
																				...
																				<div class="box_BL">
																					<div class="box_BR">
																						...
																						<div class="textbox_center" align="center">
																							...
																							<span class="title_manage"> <fmt:message
																									key="manage_subjects" bundle="${resworkflow}" />
