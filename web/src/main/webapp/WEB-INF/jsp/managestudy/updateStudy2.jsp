									...
									<div class="box_BR">
										...
										<div class="textbox_center">
											<table border="0" cellpadding="0">
												<tr valign="top">
													<td class="formlabel"><fmt:message key="study_phase"
															bundle="${resword}" />:</td>
													<td><c:set var="phase1" value="${newStudy.phase}" />

														<div class="formfieldM_BG">
															<select name="phase" class="formfieldM">
												...
												<tr valign="top">
													<td class="formlabel"><fmt:message key="protocol_type"
															bundle="${resword}" />:</td>
													<td><c:set var="type1" value="observational" /> <c:choose>
															<c:when test="${newStudy.protocolTypeKey == type1}">
																<input type="radio" checked name="protocolType"
																	value="observational" disabled>
																<fmt:message key="observational" bundle="${resword}" />
															</c:when>
															<c:otherwise>
																<input type="radio" checked name="protocolType"
																	value="interventional" disabled>
        ...
        <c:otherwise>
         <option value="<c:out value="${status.id}"/>"><c:out value="${status.name}"/>
															...
															<input type="text" name="statusName" value="Available"
																class="formfieldM" disabled> <input
													...
													<td>
														...
														<div class="formfieldM_BG">
															<input type="text" name="protocolDateVerification"
																...
																class="formfieldM" id="protocolDateVerificationField">
												...
												<tr valign="top">
													...
													<td><div class="formfieldM_BG">
															...
															<input type="text" name="startDate"
																...
																class="formfieldM" id="startDateField">
														</div> <jsp:include page="../showMessage.jsp"><jsp:param
												...
												<tr valign="top">
													...
													<td><div class="formfieldM_BG">
															<input type="text" name="endDate"
																value="<c:out value="${endDate}" />" class="formfieldM"
																id="endDateField">
														</div> <jsp:include page="../showMessage.jsp"><jsp:param
