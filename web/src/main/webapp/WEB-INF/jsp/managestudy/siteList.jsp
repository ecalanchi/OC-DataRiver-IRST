...
<tr id="sidebar_Instructions_open" style="display: all">
	<td class="sidebar_tab"><a
		...
		<div class="sidebar_tab_content">
			<fmt:message key="study_have_sites_data_collected"
				bundle="${restext}" />
...
<h1>
	<span class="title_manage"> <fmt:message
			key="manage_all_sites_in_study" bundle="${restext}" /> <c:out
			value="${study.name}" /> <a
...
<div class="homebox_bullets">
	...
	<fmt:message key="view_current_study_details" bundle="${restext}" />
	</a>
</div>
<%-- 
