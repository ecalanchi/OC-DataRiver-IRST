...
<title>OpenClinica <fmt:message key="view_data_entry"
	...
	<c:if test="${fn:length(toc.sections) gt 1}">
		...
		<td align="right" id="TabsNext"><a
			href="javascript:TabsForward()"><img src="images/arrow_next.gif"
				border="0" style="margin-top: 10px; margin-right: 6px" /></a></td>
		<td>&nbsp;
      ...
      thItem.metadata.responseLayout eq 'Horizontal'}">
        ...
        (thItem.metadata.responseSet.responseType.name eq 'checkbox' ||
              thItem.metadata.responseSet.responseType.name eq 'radio')}">
																											<th colspan="<c:out value='${optionsLen}'/>"
																														...
																														<c:forEach var="respOption"
																															...
																															<td
																																...
																																<c:set var="displayItem" scope="request"
																																	value="${bodyItem}" /> <c:set
																																	var="responseOptionBean"
           ...
           bodyItem.metadata.responseSet.responseType.name eq 'checkbox')}">
																													...
																													<c:forEach var="respOption"
																														...
																														<td
																															...
																															<c:set var="displayItem" scope="request"
																																value="${bodyItem}" /> <c:set
																																var="responseOptionBean" scope="request"
								...
								<tr>
									...
									<td valign="top" nowrap="nowrap">
										<%-- display the HTML input tag --%> <c:set var="displayItem"
											scope="request" value="${displayItem.singleItem}" /> <c:import
