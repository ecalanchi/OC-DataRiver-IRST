...
<c:choose>
	...
	<c:otherwise><jsp:include
			page="../include/submit-header.jsp" />
	</c:otherwise>
</c:choose>
...
<tr id="sidebar_Instructions_open">
	<td class="sidebar_tab"><a
		...
		<div class="sidebar_tab_content">
			<fmt:message
				key="this_section_allows_a_study_manager_to_view_and_resolve"
				bundle="${restext}" />
		</div></td>
...
<div id="sumBox" style="display: block; width: 600px;">
	...
	<table cellspacing="0" class="summaryTable" style="width: 600px;">
		...
		<c:forEach var="status" items="${mapKeys}">
			<tr>
				<td><strong>${status.name}</strong><img
					src="${status.iconFilePath}" border="0" align="right"></td>
				<c:forEach var="typeName" items="${typeNames}">
