...
<h1>
	<span class="title_manage"> <fmt:message
			...
			value="${study.name}" /> <a
		href="javascript:openDocWindow('https://docs.openclinica.com/3.1/openclinica-user-guide/submit-data-module-overview')"><img
						...
						<div class="tab_R">
							<c:choose>
								<c:when test="${! hasExtendedQuery}">
									<a class="tabtext" href="ListStudySubjects"
										onclick="javascript:HighlightTab(0);"><fmt:message
											key="all_events" bundle="${restext}" /></a>
								</c:when>
								<c:otherwise>
									<a class="tabtext" href="ListStudySubjects?${paginatingQuery}"
										onclick="javascript:HighlightTab(0);">
								</c:otherwise>
							</c:choose>
						</div>
					</div>
				...
				<div class="tab_BG_h">
					<div class="tab_L_h">
						<div class="tab_R_h">
							...
							<span class="tabtext"><fmt:message key="all_events"
									bundle="${restext}" /></span>
