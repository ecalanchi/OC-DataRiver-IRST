									...
									<div class="box_BR">
										<div class="tablebox_center">
											...
											<table border="0" cellpadding="0" cellspacing="0"
												...
												<c:forEach var="displayItem" items="${se.items}"
																		...
																		<td width="75%" style="padding-left: 12px;"><b>
																				<c:if test="${se.section.parent.active}">
																					<c:out value="${se.section.parent.title}"
																						escapeXml="false" /> &gt;
						</c:if> <c:out value="${se.section.title}" escapeXml="false" />
																		</b></td>
																	...
																	<c:if test='${section.section.subtitle != ""}'>
																		<tr>
																			<td><fmt:message key="subtitle"
																					bundle="${resword}" />:</td>
																			<td><c:out value="${se.section.subtitle}"
																					escapeXml="false" /></td>
																		</tr>
																	</c:if>
																...
																<table border="0">
																	<tr>
																		<td valign="top"><c:out
																				...
																				escapeXml="false" /></td>
																		<td valign="top"><c:out
																				value="${displayItem.metadata.leftItemText}"
																				escapeXml="false" /></td>
																		<td valign="top">
