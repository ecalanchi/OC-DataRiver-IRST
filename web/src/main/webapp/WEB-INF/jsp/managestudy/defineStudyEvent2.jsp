...
<h1>
	<span class="title_manage"><fmt:message key="define_study_event"
			bundle="${resword}" /> - <fmt:message key="select_CRFs"
			bundle="${resword}" /></span>
</h1>

<p>
	<fmt:message key="select_CRFs_to_define_study_event"
		bundle="${restext}" />
</p>
<br>
<form name="crfForm" action="DefineStudyEvent" method="post">
	...
	<c:import url="../include/showTableForEventDefinitionCRFList.jsp">
		...
		<c:param name="searchFormOnClickJS"
			value="document.crfForm.elements['actionName'].value='next';document.crfForm.elements[1].value='1';" />
	</c:import>
