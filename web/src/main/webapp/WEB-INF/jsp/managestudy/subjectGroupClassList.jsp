...
<tr id="sidebar_Instructions_open" style="display: all">
	<td class="sidebar_tab"><a
		...
		<div class="sidebar_tab_content">
			...
			<fmt:message
				key="List_of_all_subject_group_classes_with_their_subject"
				bundle="${resword}" />
			<fmt:message key="select_any_group_class_for_details_on_it_records"
				bundle="${resword}" />
			<br>
			<br>
			<fmt:message
				key="the_list_of_subject_group_classes_in_the_current_study"
				bundle="${resword}" />
...
<h1>
	<span class="title_manage"> <fmt:message
			key="manage_all_groups_in_study" bundle="${restext}" /> <c:out
			value="${study.name}" /> <a
		href="javascript:openDocWindow('https://docs.openclinica.com/3.1/openclinica-user-guide/monitor-and-manage-data/manage-all-groups')">
