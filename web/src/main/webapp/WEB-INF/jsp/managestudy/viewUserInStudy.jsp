								...
								<div class="box_BR">
									...
									<div class="tablebox_center">
										<table border="0" cellpadding="0" cellspacing="0" width="100%">
											...
											<tr>
												...
												<td class="table_cell"><c:choose>
														<c:when test="${user.sysAdmin}">
															<fmt:message key="system_administrator"
																bundle="${resword}" />
														</c:when>
														<c:otherwise>
											...
											<tr>
												<td class="table_header_column"><fmt:message key="role"
														bundle="${resword}" />:</td>
												<td class="table_cell"><c:if
														test="${uStudy.parentStudyId > 0}">
														<fmt:message key="${siteRoleMap[uRole.role.id] }"
															bundle="${resterm}"></fmt:message>
													</c:if> <c:if test="${uStudy.parentStudyId == 0}">
														<c:out value="${uRole.role.description}" />
													</c:if></td>
											</tr>
											<tr>
												<td class="table_header_column"><fmt:message
														key="study" bundle="${resword}" />:</td>
												<td class="table_cell"><c:out value="${uStudy.name}" /></td>
											</tr>
...
<br>
<p>
	<a href="ListStudyUser"><fmt:message key="go_back_to_user_list"
			bundle="${resword}" /></a>
</p>
<br>
<br>
