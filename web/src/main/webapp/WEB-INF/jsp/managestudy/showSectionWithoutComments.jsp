             ...
             <td style="width: 200px;" valign="top">--%>
								...
								<td valign="top" nowrap="nowrap">
									<%-- display the HTML input tag --%> <c:set var="displayItem"
										...
										url="../submit/showItemInput.jsp" /> <%--    <c:import url="../showMessage.jsp"><c:param name="key" value="input${displayItem.item.id}" /></c:import> --%>
								</td>
							...
							<tr>
								<td valign="top" colspan="4" style="text-align: right"><c:import
										url="../showMessage.jsp">
