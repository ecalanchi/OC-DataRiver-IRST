...
<h1>
	<span class="title_manage"><fmt:message
			key="create_a_subject_group_class" bundle="${resword}" /> <a
		href="javascript:openDocWindow('https://docs.openclinica.com/3.1/study-setup/build-study#content-title-4375')"><img
										...
										<div class="textbox_center">
											<table border="0" cellpadding="0" cellspacing="0">
												...
												<tr valign="top">
													...
													<fmt:message key="study_groups" bundle="${resword}" />:</td>

													<td><br> <c:set var="count" value="0" />
														<table border="0" cellpadding="0" cellspacing="0">
															<tr>
																<td>&nbsp;</td>
																<td>&nbsp;<strong><fmt:message key="name"
																			bundle="${resword}" /></strong></td>
																<td>&nbsp;<strong><fmt:message
																			key="description" bundle="${resword}" /></strong></td>
															</tr>
