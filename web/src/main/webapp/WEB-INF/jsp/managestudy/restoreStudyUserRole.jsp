...
<tr id="sidebar_Instructions_open" style="display: all">
	<td class="sidebar_tab"><a
		...
		<div class="sidebar_tab_content">
			<fmt:message key="confirm_restoration_of_this_user_to_study_site"
				bundle="${resword}" />
...
<h1>
	<span class="title_manage"> <fmt:message key="restore_user_role"
			bundle="${resword}" />
	</span>
</h1>
																				...
																				<div class="box_BR">
																					...
																					<div class="textbox_center" align="center">
																						...
																						<span class="title_manage"> <b><fmt:message
																									key="restore_user_role" bundle="${resword}" /></b>
