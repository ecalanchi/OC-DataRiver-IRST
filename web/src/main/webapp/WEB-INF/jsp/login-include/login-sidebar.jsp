	...
	<table border="0" cellpadding="0" cellspacing="0">
		...
		<tr>
			...
			<td style="white-space: nowrap">
				...
				<a
				href="javascript:openDocWindow('<%out.println(SQLInitServlet.getSupportURL());%>')"><span
					class="aka_font_general" style="font-size: 0.9em"><fmt:message
							key="openclinica_feedback" bundle="${resword}" /></span></a>
...
<table border="0" cellpadding=0 " cellspacing="0">
   ...
   -->
	...
	<a href="RequestAccount"> <fmt:message key="request_an_account" bundle="${resword}"/></a>--%>
				<br>
				<br> <a href="<c:url value="/RequestPassword"/>"> <fmt:message
						key="forgot_password" bundle="${resword}" /></a>
			</div> <!-- End Sidebar Contents --> <br>
		<img src="<tags:imagesLink value="spacer.gif"/>" width="120"
			height="1">
