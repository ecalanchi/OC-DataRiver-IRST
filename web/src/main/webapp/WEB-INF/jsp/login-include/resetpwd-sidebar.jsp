...
<table border="0" cellpadding=0 " cellspacing="0">
	<tr>
		<td class="sidebar" valign="top">
			<!-- Sidebar Contents --> <br>
		<br> <a href="MainMenu">&nbsp;<fmt:message key="home"
					bundle="${resworkflow}" /></a> <br>
		<br> <!--    <a href="RequestAccount">&nbsp;<fmt:message key="request_an_account" bundle="${resword}"/></a>
    <br><br>
    <a href="RequestPassword">&nbsp;<fmt:message key="forgot_password" bundle="${resword}"/></a>
    
    --> <!-- End Sidebar Contents --> <br>
