...
<h1>
	<span class="title_manage"><fmt:message
			...
			key="data_committed_successfully" bundle="${resword}" /></span>
</h1>
<br />
<fmt:message key="the_new_CRF_version_was_committed_into"
	bundle="${restext}" />
<br />
<p>
<div class="homebox_bullets">
	<a href="ListCRF"><fmt:message key="go_back_to_the_CRF_list"
			bundle="${restext}" /></a>
</div>
<p>
<div class="homebox_bullets">
	<a
		href="ViewSectionDataEntry?crfVersionId=<%=request.getAttribute("crfVersionId")%>&tabId=1"><fmt:message
			key="view_CRF_version_data_entry" bundle="${resword}" /></a>
</div>
<p>
<div class="homebox_bullets">
...
<p>
<div class="homebox_bullets">
	<a href="ViewCRFVersion?id=<%=request.getAttribute("crfVersionId")%>"><fmt:message
			key="crf_version_metadata" bundle="${resword}" /></a>
</div>
