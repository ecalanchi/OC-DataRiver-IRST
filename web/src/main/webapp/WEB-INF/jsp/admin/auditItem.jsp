	...
	<c:choose>
		<c:when test="${fn:length(itemAudits)>0}">
					...
					<td>
						...
						<table border="0" cellpadding="0" cellspacing="0" width="550"
							...
							<tr>
								...
								<td class="table_cell"><b><fmt:message key="user"
											bundle="${resword}" /></b></td>
								<td class="table_cell"><b><fmt:message key="value_type"
											bundle="${resword}" /></b></td>
								<td class="table_cell"><b><fmt:message key="old"
											bundle="${resword}" /></b></td>
								<td class="table_cell"><b><fmt:message key="new"
											bundle="${resword}" /></b></td>
							</tr>
							<c:forEach var="audit" items="${itemAudits}">
								<tr>
									<td class="table_cell"><c:out
											value="${audit.auditEventTypeName}" />&nbsp;</td>
									<td class="table_cell"><fmt:formatDate
											value="${audit.auditDate}" type="both"
			...
			<tr>
				<p>
					&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;(
					<fmt:message key="item_initially_entered_on" bundle="${respage}" />
					<c:out value="${param.entityCreatedDate}" />
					.)
				</p>
			</tr>
		</c:when>
		<c:otherwise>
			<p>
				&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;(
				<fmt:message key="no_changed_made_since_item_initially_entered_on"
					bundle="${respage}" />
				<c:out value="${param.entityCreatedDate}" />
				.)
			</p>
