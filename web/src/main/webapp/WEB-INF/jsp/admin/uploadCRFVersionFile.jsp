...
<h1>
	<span class="title_manage"><fmt:message
			key="create_a_CRF_version_for" bundle="${restext}" /> <c:out
			value="${crfName}" /> </span>
</h1>
...
<form
	action="CreateCRFVersion?action=submit&crfId=<c:out value="${version.crfId}"/>&name=<c:out value="${version.name}"/>"
									...
									<div class="box_BR">
										...
										<div class="textbox_center" align="center">
											<table border="0" cellpadding="0" cellspacing="0"
												width="100%">
												<tr>
													<td class="formlabel"><fmt:message key="version_name"
															bundle="${resword}" />:</td>
												...
												<tr>
													...
													<td><div class="formfieldFile_BG">
															<input type="file" name="excel_file" class="formfieldM">
														</div></td>
												</tr>
											</table>
										</div>
	...
	<input type="submit" name="submit"
		value="<fmt:message key="upload_excel_file" bundle="${resword}"/>"
		class="button_xlong">
</form>
