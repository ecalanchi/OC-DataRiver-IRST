...
<h1>
	<span class="title_manage"><fmt:message
			key="scheduled_export_data_jobs" bundle="${resword}" /><a
		href="javascript:openDocWindow('https://docs.openclinica.com/3.1/brief-overview/jobs#content-title-4363')"><img
...
<div class="homebox_bullets">
	<a href="CreateJobExport">Create a new Export Data Job</a>
</div>
