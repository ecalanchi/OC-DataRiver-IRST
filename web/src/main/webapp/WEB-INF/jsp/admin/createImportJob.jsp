...
<h1>
	<span class="title_manage">Create Scheduled Job: Import Data</span>
</h1>
<p>
	...
	<table>
		...
		<tr>
			...
			<td class="text"><input type="text" name="contactEmail"
				size="90" /> <br><jsp:include page="../showMessage.jsp"><jsp:param
						name="key" value="contactEmail" /></jsp:include></td>
		</tr>
