...
<h1>
	<span class="title_manage"><fmt:message
			key="create_scheduled_job_export_dataset" bundle="${resword}" /></span>
</h1>
<p>
<form action="CreateJobExport" method="post">
	...
	<P>
		<I><fmt:message key="note_that_job_is_set" bundle="${resword}" />
			<fmt:formatDate value="${now}" pattern="${dtetmeFormat}" />.</I>
	</P>
		...
		<tr>
			...
			<td class="text">
				<table border="0" cellpadding="0" cellspacing="0">
					...
					<tr>
						<td colspan="7"><jsp:include page="../showMessage.jsp"><jsp:param
									name="key" value="jobDate" /></jsp:include></td>
					</tr>
				</table>
			</td>
		</tr>
