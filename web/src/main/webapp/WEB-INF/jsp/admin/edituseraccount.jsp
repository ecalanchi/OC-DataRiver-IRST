...
<h1>
	<span class="title_manage"><fmt:message
			key="edit_a_user_account" bundle="${resword}" /></span>
</h1>


<form action="EditUserAccount" method="post">
	<jsp:include page="../include/showSubmitted.jsp" />
	<jsp:include page="../include/showHiddenInput.jsp"><jsp:param
			name="fieldName" value="userId" /></jsp:include>
	<jsp:include page="../include/showHiddenInput.jsp"><jsp:param
			name="fieldName" value="stepNum" /></jsp:include>
									...
									<div class="box_BR">
										...
										<div class="tablebox_center">
											...
											<table border="0" cellpadding="0" cellspacing="0"
													...
													<td valign="top">
														<table border="0" cellpadding="0" cellspacing="0">
															...
															<tr>
																<td colspan="2"><jsp:include
																		page="../showMessage.jsp"><jsp:param
																			name="key" value="lastName" /></jsp:include>
															</tr>
														</table>
													</td>
												</tr>
												...
												<tr valign="top">
													<td class="table_header_column"><fmt:message
															key="user_type" bundle="${resword}" />:</td>
													<td valign="top">
														<table border="0" cellpadding="0" cellspacing="0">
															<tr>
																<td valign="top"><div class="formfieldM_BG">
																				...
																				<c:choose>
																					<c:when test="${userTypeId == type.id}">
																						<option value='<c:out value="${type.id}" />'
																							selected><c:out value="${type.name}" /></option>
																					</c:when>
																					<c:otherwise>
															...
															<tr>
																<td colspan="2"><jsp:include
																		page="../showMessage.jsp"><jsp:param
																			name="key" value="userType" /></jsp:include></td>
															</tr>
														</table>
													</td>
												</tr>
															...
															<table border="0" cellpadding="0" cellspacing="0">
																<tr>
																	<td valign="top"><input type="checkbox"
																		name="runWebServices" id="runWebServices" value="1"
     ...
     function a() {
       if (document.getElementById('resetPassword').checked){
         ...
         document.getElementById('displayPwd1').disabled=true
													...
													<tr>
														<td colspan=2 class="table_header_column"><input
															type="checkbox" name="resetPassword" id="resetPassword"
															value="1"
															<c:if test="${resetPassword != 0}">
                        checked
                    </c:if>
															onclick="javascript:a()"> <fmt:message
																key="reset_password" bundle="${resword}" /></td>
													</tr>
													<tr>
														<td colspan="2"><c:choose>
																<c:when test="${displayPwd == 'no'}">
																	<c:if test="${notifyPassword eq 'email'}">
																		<input type="radio" name="displayPwd" id="displayPwd0"
																			value="no" disabled="true">
																		<fmt:message key="send_user_password_via_email"
																			bundle="${resword}" />
																	</c:if>
																	<input type="radio" checked name="displayPwd"
																		id="displayPwd1" value="yes" disabled="true">
	...
	<table border="0" cellpadding="0" cellspacing="0">
		<tr>
			<td><input type="submit" name="Submit"
				value="<fmt:message key="next" bundle="${resword}"/>"
