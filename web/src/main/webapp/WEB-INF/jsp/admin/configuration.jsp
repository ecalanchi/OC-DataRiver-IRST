...
<h1>
	<span class="title_manage"><fmt:message
			key="lock_out_configuration" bundle="${resword}" /></span>
</h1>
											...
											<table border="0" cellpadding="0" cellspacing="0"
												...
												<tr valign="top">
													<td class="table_header_column"><fmt:message
															key="lockout_enabled" bundle="${resword}" />:</td>
													<td valign="top">
														<table border="0" cellpadding="0" cellspacing="0">
															<tr>
															...
															<tr>
																<td colspan="2"><jsp:include
																		page="../showMessage.jsp"><jsp:param
																			name="key" value="lockswitch" /></jsp:include></td>
															</tr>
														</table>
													</td>
												</tr>
												...
												<tr>
													<td class="table_header_column_top"><fmt:message
															key="number_of_failed_attempts" bundle="${resword}" />:</td>
													<td valign="top">
														<table border="0" cellpadding="0" cellspacing="0">
															<tr>
																<td valign="top"><div class="formfieldM_BG">
																		<input type="text" name="lockcount"
																			value="<c:out value="${lockcount}"/>" size="20"
																			class="formfieldM" />
																	</div></td>
															</tr>
															<tr>
																<td colspan="2"><jsp:include
																		page="../showMessage.jsp"><jsp:param
																			name="key" value="lockcount" /></jsp:include></td>
															</tr>
														</table>
													</td>
												</tr>
