...
<h1>
	<span class="title_manage"><fmt:message
			key="view_scheduled_inport_jobs" bundle="${resword}" /><a
		href="javascript:openDocWindow('https://docs.openclinica.com/3.1/brief-overview/jobs#content-title-4364')"><img
...
<div class="homebox_bullets">
	<a href="CreateJobImport"><fmt:message
			key="create_a_new_import_data_job" bundle="${resword}" /></a>
</div>
<p></p>
...
<P>
	<I>Note that all jobs are set to run on the server time. The
		current server time is <fmt:formatDate value="${now}"
...
<br>
<br>
<input type="button" onclick="confirmExit('ViewAllJobs');" name="exit"
