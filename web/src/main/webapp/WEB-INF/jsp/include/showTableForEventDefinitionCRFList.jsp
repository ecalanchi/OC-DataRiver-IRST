...
<c:set var="firstPageQuery"
	value="${table.baseGetQuery}&ebl_page=1&ebl_sortColumnInd=${table.sortingColumnInd}&ebl_sortAscending=${ascending}&ebl_filtered=${filtered}&ebl_filterKeyword=${table.keywordFilter}&ebl_paginated=1&next_list_page=true" />
<c:set var="prevPageQuery"
	value="${table.baseGetQuery}&ebl_page=${table.currPageNumber - 1}&ebl_sortColumnInd=${table.sortingColumnInd}&ebl_sortAscending=${ascending}&ebl_filtered=${filtered}&ebl_filterKeyword=${table.keywordFilter}&ebl_paginated=1&next_list_page=true" />
<c:set var="nextPageQuery"
	value="${table.baseGetQuery}&ebl_page=${table.currPageNumber + 1}&ebl_sortColumnInd=${table.sortingColumnInd}&ebl_sortAscending=${ascending}&ebl_filtered=${filtered}&ebl_filterKeyword=${table.keywordFilter}&ebl_paginated=1&next_list_page=true" />
<c:set var="lastPageQuery"
	value="${table.baseGetQuery}&ebl_page=${table.totalPageNumbers}&ebl_sortColumnInd=${table.sortingColumnInd}&ebl_sortAscending=${ascending}&ebl_filtered=${filtered}&ebl_filterKeyword=${table.keywordFilter}&ebl_paginated=1&next_list_page=true" />
<c:set var="viewAllQuery"
	value="${table.baseGetQuery}&ebl_page=${1}&ebl_sortColumnInd=${table.sortingColumnInd}&ebl_sortAscending=${ascending}&ebl_filtered=0&ebl_filterKeyword=&ebl_paginated=0&next_list_page=true" />
<c:set var="doNotPaginateQuery"
	value="${table.baseGetQuery}&ebl_page=1&ebl_sortColumnInd=${table.sortingColumnInd}&ebl_sortAscending=${ascending}&ebl_filtered=${filtered}&ebl_filterKeyword=${table.keywordFilter}&ebl_paginated=0&next_list_page=true" />
<c:set var="paginateQuery"
	value="${table.baseGetQuery}&ebl_page=1&ebl_sortColumnInd=${table.sortingColumnInd}&ebl_sortAscending=${ascending}&ebl_filtered=${filtered}&ebl_filterKeyword=${table.keywordFilter}&ebl_paginated=1&next_list_page=true" />
<c:set var="removeFilterQuery"
	value="${table.baseGetQuery}&ebl_page=${table.currPageNumber}&ebl_sortColumnInd=${table.sortingColumnInd}&ebl_sortAscending=${ascending}&ebl_filtered=0&ebl_filterKeyword=&ebl_paginated=${paginated}&next_list_page=true" />
															...
															<table border="0" cellpadding="0" cellspacing="0">
																<tr>
																	<td valign="top" class="table_tools"><c:if
																			...
																			<a href="#"
																				onclick="document.forms[1].action='<c:out value="${firstPageQuery}"/>';document.forms[1].submit()"><img
																			...
																			<a href="#"
																				onclick="document.forms[1].action='<c:out value="${prevPageQuery}"/>';document.forms[1].submit()"><img
																	...
																	<td valign="top" class="table_tools"><c:if
																			...
																			<a href="#"
																				onclick="document.forms[1].action='<c:out value="${nextPageQuery}"/>';document.forms[1].submit()"><img
																				src="images/arrow_next.gif" border="0"
																				alt="<fmt:message key="next" bundle="${resword}"/>"
																				title="<fmt:message key="next" bundle="${resword}"/>"></a>
																			<a href="#"
																				onclick="document.forms[1].action='<c:out value="${lastPageQuery}"/>';document.forms[1].submit()"><img
															...
															<table border="0" cellpadding="0" cellspacing="0">
																<tr>
																	...
																	<c:forEach var="link" items="${table.links}">
																		...
																		<c:choose>
																			<c:when
																				test="${link.caption != 'Enterprise CRF Library'}">
																			...
																			<c:otherwise>
																				<td class="table_tools"><b><a
																						...
																						target="_blank"><c:out value="${link.caption}" /></a></b></td>
																			</c:otherwise>
																		</c:choose>
																		<c:set var="isFirstLink" value="${false}" />
																	</c:forEach>
																			...
																			<c:forEach var="column" items="${table.columns}">
																				...
																				<c:choose>
																					...
																					<c:when test="${column.name eq 'Last Updated by'}">
																						<c:out value="Last<br /> Updated by"
																							escapeXml="false" />
																					</c:when>
