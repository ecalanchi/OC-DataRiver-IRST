...
<c:choose>
	<c:when test="${userBean != null && userBean.id>0}">
		...
		<tr id="sidebar_Info_open"
			<c:if test="${closeInfoShowIcons}">style="display: none"</c:if>>
			<td class="sidebar_tab"><a
				href="javascript:leftnavExpand('sidebar_Info_open'); leftnavExpand('sidebar_Info_closed');">

					<img
					src="${pageContext.request.contextPath}/images/sidebar_collapse.gif"
					border="0" align="right" hspace="10">
			</a> <b><fmt:message key="info" bundle="${restext}" /></b>
       ...
       //-->
		...
		<tr id="sidebar_Info_closed"
			...
			<td class="sidebar_tab"><a
				href="javascript:leftnavExpand('sidebar_Info_open'); leftnavExpand('sidebar_Info_closed');"><img
					...
					border="0" align="right" hspace="10"></a> <b>Info</b></td>
		</tr>
		...
		<c:if
			test="${(!panel.iconInfoShown && panel.manageSubject) || closeInfoShowIcons}">
			<c:import url="/WEB-INF/jsp/include/sideIconsSubject.jsp" />
		</c:if>
