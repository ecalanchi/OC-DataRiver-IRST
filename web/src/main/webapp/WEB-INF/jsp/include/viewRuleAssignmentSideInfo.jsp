...
<c:choose>
	<c:when test="${userBean != null && userBean.id>0}">
			...
			<td class="sidebar_tab"><a
				...
				<div class="sidebar_tab_content">
					...
					<span style="color: #789EC5"> <c:if
							test="${panel.studyInfoShown}">
							<c:import
								url="/WEB-INF/jsp/include/viewRuleAssignmentStudySideInfo.jsp" />
							<br>
						</c:if> <c:if test="${panel.createDataset}">
							<!--
        ...
        -->
							...
							<br>
							<br>
						</c:if> <br> <c:if test="${newDataset.id>0}">
