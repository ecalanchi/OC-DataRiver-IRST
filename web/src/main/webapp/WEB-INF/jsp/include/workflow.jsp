	...
	<tr>
		<td id="sidebar_Workflow_closed" style="display: none"><a
			href="javascript:leftnavExpand('sidebar_Workflow_closed'); leftnavExpand('sidebar_Workflow_open');"><img
				src="${imagePathPrefix}images/<fmt:message key="image_dir" bundle="${resformat}"/>/tab_Workflow_closed.gif"
				border="0"></a></td>
						...
						<table border="0" cellpadding="0" cellspacing="0">
							<tr>
								<td class="workflow_tab"><a
									href="javascript:leftnavExpand('sidebar_Workflow_closed'); leftnavExpand('sidebar_Workflow_open');"><img
										src="${imagePathPrefix}images/sidebar_collapse.gif" border="0"
										align="right" hspace="10"></a> <b><fmt:message
											key="workflow" bundle="${resword}" /></b></td>
							</tr>
						</table>
					</td>
					<td class="workflowBox_T" align="right" valign="top"><img
						src="${imagePathPrefix}images/workflowBox_TR.gif"></td>
				</tr>
				<tr>
									...
									<div class="workflowBox_center">
										...
										<table border="0" cellpadding="0" cellspacing="0">
											<tr>
												...
												<c:if test="${trail != null || trail.size > 0}">
													...
													<c:forEach var="breadcrumb" items="${trail}"
														varStatus="status">
								  	...
								  	--%>
																								...
																								<c:if test="${breadcrumb.status.id == 4}">
																									...
																									<c:set var="activeBreadcrumbDisplayed"
																										value="${1}" />
																								</c:if>
