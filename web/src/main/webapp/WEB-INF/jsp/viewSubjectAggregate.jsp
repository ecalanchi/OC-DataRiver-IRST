...
<tr id="sidebar_Instructions_open">
	<td class="sidebar_tab"><a
		...
		<div class="sidebar_tab_content">
			...
			<fmt:message key="design_implement_sdv_study_subject"
				bundle="${restext}" />
...
<h1>
	<span class="title_manage"> <fmt:message key="sdv_sdv_for"
			bundle="${resword}" /> <c:out value="${study.name}" /> <a
		href="javascript:openDocWindow('https://docs.openclinica.com/3.1/openclinica-user-guide/monitor-and-manage-data')">
	...
	<table border="0" cellpadding="0" cellspacing="0">
		<tr>
			<td valign="bottom" id="Tab1'">
						...
						<div class="tab_L">
							<div class="tab_R">
								<a class="tabtext"
									...
									href='viewAllSubjectSDVtmp?sdv_restore=true&studyId=${studyId}'
				...
				<div id="Tab1NotSelected" style="display: none">
					<div class="tab_BG_h">
						<div class="tab_L_h">
							<div class="tab_R_h">
								<span class="tabtext">View By Event CRF</span>
							</div>
						</div>
					</div>
				</div>
						...
						<div class="tab_L">
							<div class="tab_R">
								<a class="tabtext"
									...
									href='viewSubjectAggregate?studyId=${studyId}'
...
<div id="subjectSDV">
	<form name='sdvForm'
		action="${pageContext.request.contextPath}/pages/viewSubjectAggregate">
