...
//      factory.setRandomizationArmsDao(getRandomizationArmsDAO());
      factory.setStudyGroupClassBean(studyGroupClassBean);
//      factory.setRandomizationSubjectsDao(getRandomizationSubjectsDAO());
