     ...
     /**
      * @author DataRiver 14/05/2012
      *
      */
     
     public class RandomizationStatusStatisticView extends AbstractHtmlView {
     	
     	private final ResourceBundle resword;
     
         public RandomizationStatusStatisticView(Locale locale) {
     	  ...
     	  public Object render() {
     	    ...
     	    private String customHeader(){
     	    	 HtmlBuilder html = new HtmlBuilder();
     		        ...
     		        html.td(0).colspan("4").style("border-bottom: 1px solid white;background-color:white;color:grey;").align("center").close().append(resword.getString("subject_enrollment_for_randomization")).tdEnd();
